...
async def process_help_command(message: Message):
    await message.reply("<b>Что может этот бот?</b>\n\n"
                        ...
                        "\\help - помощь по боту\n"
                        "\\my_goods - товары, обавленные для отслеживания цен\n"
                        "\n"
...
async def echo_message(message: Message, bot):
    ...
    # отправляет сообщение об обработке запроса, а затем удаляет его пока 60 сек, в дальнейшим пока
